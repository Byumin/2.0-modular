...
- Basic:
  - `node scripts/capture_screenshot.mjs --url http://127.0.0.1:8120/assessment/custom/<token>`

- Custom output path:
  - `node scripts/capture_screenshot.mjs --url http://127.0.0.1:8120/admin/create --out artifacts/screenshots/admin-create.png`

- Wait for a selector before capture:
  - `node scripts/capture_screenshot.mjs --url http://127.0.0.1:8120/admin/create --selector #createTestForm`
